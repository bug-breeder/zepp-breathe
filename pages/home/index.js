  ...
  build() {
    renderPage({
      ...
      buildFn: (c) => {
        ...
        // Layout math: spacer(16)+label(52)+text-title(88)+text-sub(72) = 228
        // Start(72+6=78)+Stats(48+6=54) = 132. Total 228+132=360 = MINIMAL.h ✓
        col.chip('Start', {
          variant: 'primary',
          radius: 36, // h/2 = true pill; RADIUS.pill(999) renders as ellipse in ZeppOS
          h: 72,
          w: 192,
